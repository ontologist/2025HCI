                    ...
                    <form id="site-otp-form">
                        <div class="site-form-group">
                            ...
                            <input 
                                ...
                                autofocus
                            />
                            <small class="site-help-text" id="site-otp-expiry-text">Code expires in 15 minutes</small>
                        </div>
    ...
    async handleEmailSubmit() {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Update expiry text with value from backend
                const expiryMinutes = data.expires_in_minutes || 15;
                const expiryText = document.getElementById('site-otp-expiry-text');
                if (expiryText) {
                    expiryText.textContent = `Code expires in ${expiryMinutes} minutes`;
                }
...
(function() {
    ...
    // Initialize auth immediately (don't wait for DOMContentLoaded)
    // This ensures auth runs as soon as the script loads
    function initAuth() {
    ...
    // The inline script in <head> already handles the initial hiding
    initAuth();
})();
